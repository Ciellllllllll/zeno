...
The package config exposes `ZenoEngine::zeno_sdk_cpp`, numeric `ZenoEngine_VERSION` as `0.1.0`, and `ZenoEngine_RELEASE_LABEL` as `0.1.0-rc.1`. Compatibility `ZENO::` targets are also provided for older local examples.
